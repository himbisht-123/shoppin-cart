...
export default class Cart extends Component {
    ...
    render() {
        ...
        return (
               ...
               <div> 
                {cartItems.length===0?(<div className="cart cart-header">Shopping Cart is empty</div>)
                :
                (<div className="cart cart-header">You have {cartItems.length} {cartItems.length<=1?"item":"items"} in the cart {" "}
                </div>
                )}
                <div>
               <div className="cart">
